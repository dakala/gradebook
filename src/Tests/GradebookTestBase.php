...
/**
 * @file
 * Contains \Drupal\gradebook\Tests\ShortcutTestBase.
 */

namespace Drupal\gradebook\Tests;

use Drupal\gradebook\Entity\GradeLetter;
...
abstract class ShortcutTestBase extends WebTestBase {
  ...
  /**
   * Site-wide default grade letter set.
   *
  ...
  protected function setUp() {
    ...
    if ($this->profile != 'standard') {
      ...
      $shortcut = GradeLetter::create(array(
        'grade_letter_set' => 'default',
        'title' => t('Add content'),
        'weight' => -20,
        'link' => array(
  ...
  function generateGradeLetterSet($label = '', $id = NULL) {
    $set = GradeLetterSet::create(array(
