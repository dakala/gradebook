...
/**
 * Defines a storage for grade category entities.
 */
class GradeCategoryStorage extends ConfigEntityStorage implements GradeCategoryStorageInterface {
  ...
  /**
   * Constructs a GradeCategoryStorageController object.
   *
